...
export function buyUpgrade(id, btn) {
  ...
  switch (id) {
    ...
    case 'yumak':
      const yumak = gs.objects.find((o) => o.type === 'yarnball');
      yumak.active = true;
      yumak.visible = true;
      purchase(upg, btn, 2n);
      break;
    ...
    case 'evCicek':
      const evcicek = gs.objects.find((o) => o.type === 'evCicek');
      evcicek.active = true;
    ...
    case 'hoparlor':
      ...
      const speaker = gs.objects.find((o) => o.type === 'hoparlor');
      gs.speakerOn = true;
    ...
    case 'postaKutusu':
      ...
      gs.postaKutusu = true;
      const posta = gs.objects.find((o) => o.type === 'posta');
    ...
    case 'kazancTablo':
      ...
      const table = gs.objects.find((o) => o.type === 'incomeTable');
      table.active = true;
      table.visible = true;
    ...
    case 'garajCicek':
      ...
      const cicek = gs.objects.find((o) => o.type === 'garajCicek');
      cicek.active = true;
      cicek.visible = true;
    ...
    case 'sunucu16':
      ...
      const sw16 = gs.objects.find((o) => o.type === 'server16');
      sw16.active = true;
      sw16.visible = true;
    ...
    case 'bardaklar':
      ...
      const cups = gs.objects.find((o) => o.type === 'cupShelf');
      cups.active = true;
      cups.visible = true;
    ...
    case 'tshirtler':
      ...
      const shirts = gs.objects.find((o) => o.type === 'tshirtShelf');
      shirts.active = true;
      shirts.visible = true;
    ...
    case 'sapkalar':
      ...
      const hats = gs.objects.find((o) => o.type === 'hatShelf');
      hats.active = true;
      hats.visible = true;
    ...
    case 'danisman':
      ...
      const danisman = gs.objects.find((o) => o.type === 'danisman');
    ...
    case 'sunucu32':
      ...
      const sw32 = gs.objects.find((o) => o.type === 'server32');
      sw32.active = true;
      sw32.visible = true;
    ...
    case 'telefon':
      ...
      const phone = gs.objects.find((o) => o.type === 'phoneShelf');
      phone.active = true;
      phone.visible = true;
    ...
    case 'araba':
      ...
      const car = gs.objects.find((o) => o.type === 'car');
      car.active = true;
      car.visible = true;
      car.collidable = true;
    ...
    case 'kilim':
      const kilim = gs.objects.find((o) => o.type === 'rug');
      kilim.active = true;
      kilim.visible = true;
